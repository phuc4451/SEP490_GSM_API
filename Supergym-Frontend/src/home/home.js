                        ...
                        <div className="col-12">
                            <nav className="main-nav">
                                ...
                                <div className="back-dashboard">
                                    <div className="main-button manage-button pe-4"><a href="/dashboard"><FontAwesomeIcon icon={faBackward} /> quản lí</a></div>
                                ...
                                <ul className="nav">
                                    ...
                                    <li className="scroll-to-section">
                                        <a
                                            href="#our-classes"
                                            className={activeSection === 'our-classes' ? "active" : ""}
                                            onClick={() => handleSetActive('our-classes')}
                                        >
                                            Lớp tập
                                        </a>
                                    </li>
            ...
            <div className="main-banner" id="top">
                ...
                <div className="video-overlay header-text">
                    <div className="caption">
                        ...
                        <h2>Đồng hành cùng với <em>Super gym</em></h2>
                ...
                <div className="container">
                    ...
                    <div className="row" id="tabs">
                        <div className="col-lg-4">
                            <ul>
                                <li><a href="#tabs-1" onClick={(e) => { e.preventDefault(); setActiveTab(1); }}><img src={tabFirstIcon} alt="First Training Icon" /> First Training className</a></li>
                                <li><a href="#tabs-2" onClick={(e) => { e.preventDefault(); setActiveTab(2); }}><img src={tabFirstIcon} alt="Second Training Icon" /> Second Training className</a></li>
                                <li><a href="#tabs-3" onClick={(e) => { e.preventDefault(); setActiveTab(3); }}><img src={tabFirstIcon} alt="Third Training Icon" /> Third Training className</a></li>
                                <li><a href="#tabs-4" onClick={(e) => { e.preventDefault(); setActiveTab(4); }}><img src={tabFirstIcon} alt="Fourth Training Icon" /> Fourth Training className</a></li>
                ...
                <div className="container">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="footer-widget">
                                ...
                                <ul className="footer-contact">
                                    <li><i className="fa-solid fa-marker"></i> 203 Fake St. Mountain View, San Francisco, California, USA</li>
                                    <li><i className="fa-solid fa-phone"></i> +2 392 3929 210</li>
                                    <li><i className="fas fa-envelope"></i> info@yourdomain.com</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-12 text-center">
                            <p>Copyright &copy; 2024 All rights reserved | This template is made with <i className="fas fa-heart"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a></p>
                        </div>
                    </div>
                </div>
            </footer>
