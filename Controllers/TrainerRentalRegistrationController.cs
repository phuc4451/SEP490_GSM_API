...
namespace Alpha_API.Controllers
{
	...
	public class TrainerRentalRegistrationController : ControllerBase
	{
		...
		public TrainerRentalRegistrationController(RegisterService registerService, FirebaseClientProvider firebaseClientProvider, FirebaseClient firebaseClient, FirebaseAuth firebaseAuth, EmailService emailService)
		{
		...
		public async Task<ActionResult<TrainerRentalRegistration>> CreateRegistration(RegisterRequest request)
		{
